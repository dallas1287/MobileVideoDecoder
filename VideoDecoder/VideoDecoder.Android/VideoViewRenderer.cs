...
[assembly: ExportRenderer(typeof(VideoDecoder.CustomMediaView), typeof(VideoDecoder.Droid.VideoViewRenderer))]

namespace VideoDecoder.Droid
{
    class VideoViewRenderer : FrameLayout, IVisualElementRenderer, IViewRenderer
    {
        int? defaultLabelFor;
        CustomMediaView element;
        VisualElementTracker visualElementTracker;
        VisualElementRenderer visualElementRenderer;
        FragmentManager fragmentManager;
        CustomMediaFragment fragment;
        ...
        CustomMediaView Element
        {
            ...
            set
            {
                ...
                element = value;
                OnElementChanged(new ElementChangedEventArgs<CustomMediaView>(oldElement, element));
            }
        }
        ...
        void OnElementChanged(ElementChangedEventArgs<CustomMediaView> e)
        {
            CustomMediaFragment newFragment = null;
            ...
            if (e.NewElement != null)
            {
                ...
                newFragment = new CustomMediaFragment { Element = element };
            }

            FragmentManager.BeginTransaction()
                .Replace(Id, fragment = newFragment)
                .Commit();
        ...
        {
            if (!(element is CustomMediaView customMedia))
            {
                throw new ArgumentException($"{nameof(element)} must be of type {nameof(CustomMediaView)}");
            }
